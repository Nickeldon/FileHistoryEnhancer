...
.dropzone.dz-drag-hover{border-style:solid; opacity: 40%; filter: brightness(200%);}
...
.dropzone .dz-preview{position:relative;display:inline-block;vertical-align:middle;margin:16px;min-height:100px}
...
.dropzone .dz-preview .dz-details .dz-size span{background-color:rgba(255,255,255,.4);padding:0 .4em;border-radius:3px}
